Skript **"backend.py"** spustí webový server (zatím bez front endu) a zároveň spustí MQTT, kterým poslouchá příchozí zprávy, ze kterých rovnou ukládá data do db.
